                                        ...
                                        <div class="box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="text[]"
                                                    value="{{ $page_content->text }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="link">Link</label>
                                                <input type="text" class="form-control" name="link[]"
                                                    value="{{ $page_content->link }}">
                                            </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control" name="image[]"
                                                            accept="image/*"
                                                            onchange="loadFile(event, '{{ $page_content->id }}')">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="image_div_{{ $page_content->id }}" style="display: none;">
                                                        <img id="image_preview_{{ $page_content->id }}"
                                                            class="display_image" height="80" width="100">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="seo_keyword"
                                                    ...
                                                    data-role="tagsinput" value="{{ $page->seo_keyword }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($page->seo_image)
                                                    <small class="text-muted">Current Image:
                                                        {{ $page->seo_image }}</small>
                                                    <img src="{{ asset('storage/page/seo_' . $page->seo_image) }}"
