...
@section('title')
    {{ env('APP_NAME') }} | Create Destination Fact
@endsection
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Create Destination Fact
            <small>Add/Modify Destination Fact</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{ route('destination-tests.index') }}">Destination Facts</a></li>
            <li class="active">Create Destination Fact</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Create Destination Fact</h3>
                    </div>

                    <!-- Form Start -->
                    <form class="form" method="post" action="{{ route('destination-facts.store') }}"
