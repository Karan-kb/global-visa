...
@push('css')
    <style>
        ...
        /* Ensure images stay centered and responsive */
        #example1 img.img-fluid {
            margin: 0 auto;
            display: block;
        }
    </style>
                ...
                <div class="box">
                    ...
                    <td>{{$info->address1}}</td>
                                ...
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>Logo</td>
                                    <td><img src="/storage/info/{{ $info->logo }}" class="img-fluid" width="50px"
                                            width="50px"></td>
                                </tr>
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>Favicon</td>
                                    <td><img src="/storage/info/{{ $info->favicon }}" class="img-fluid" width="50px"
                                            width="50px"></td>
                                </tr>
                                <tr>
                                    <td>{{ $i++ }}</td>
                                ...
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>Map</td>
                                    <td>{{ Illuminate\Support\Str::limit($info->map,'100','...') }}</td>
                                </tr>
                                <tr>
                                    <td>{{ $i++ }}</td>
