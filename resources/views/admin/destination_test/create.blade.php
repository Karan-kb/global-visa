...
@section('title')
    {{ env('APP_NAME') }} | Create Destination Test
@endsection
...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create Destination Test</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Create Destination Test</h3>
                    </div>

                    <!-- Form Start -->
                    <form class="form" method="post" action="{{ route('destination-tests.store') }}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="destination_id">Country <span class="required">*</span></label>
