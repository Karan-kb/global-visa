                            ...
                            <tbody>
                                @foreach ($blog as $blogs)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/blog/{{ $blogs->id }}/edit" style="border-radius:50%"
                                        ...
                                        <td>
                                            <form method="post" action="/blog/{{ $blogs->id }}">
                                                ...
                                                <button style="border-radius:50%"
                                                    onclick="return confirm('Are You Sure...Do you want to delete this Blog?')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('blog.store') }}" method="POST" class="form-container"
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control cat_dropdown" style="width:100%; height:34px"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body" id="editor" class="form-control" id="" cols="30" rows="10"
