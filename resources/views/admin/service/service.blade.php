                            ...
                            <tbody>
                                @foreach ($service as $service)
                                    <tr>
                                        <td>{{ $service->id }}</td>
                                        <td>{{ $service->title }}</td>
                                        <td><img src="storage/services/{{ $service->image }}" class="img-fluid"
                                        ...
                                        <td>
                                            <a href="/service/{{ $service->id }}/edit" style="border-radius:50%"
                                        ...
                                        <td>
                                            <form method="post" action="/service/{{ $service->id }}">
                                                ...
                                                <button style="border-radius:50%"
                                                    onclick="return confirm('Are You Sure...Do you want to delete this Service?')"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('service.store') }}" method="POST" class="form-container"
